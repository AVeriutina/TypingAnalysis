...
struct CRusLocale {
  ...
  struct CStatistics {
    ...
    static constexpr const char* MaxLikelihoodSpeedHint =
        ...
        "плотности распределения скорости (первый график). Она показывает "
        "скорость ваших физических возможностей.";
    static constexpr const char* ScoreHint =
        "Баллы начисляются за технику печати от 0 до 100, чем ближе к 100 тем "
        "лучше";
  };
